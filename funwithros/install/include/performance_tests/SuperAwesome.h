...
struct SuperAwesome_
{
  ...
  _header_type header;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _awesome_type;
  _awesome_type awesome;
...
// {'std_msgs': ['/opt/ros/kinetic/share/std_msgs/cmake/../msg'], 'performance_tests': ['/home/bonolo/Documents/CV/Robotics/BlueOceanRobotics/Assignment/FunWithROS/funwithros/src/performance_tests/msg']}
...
struct MD5Sum< ::performance_tests::SuperAwesome_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x4b79564452a70ac6ULL;
  static const uint64_t static_value2 = 0xef155a29a39e7b9fULL;
};
...
struct Printer< ::performance_tests::SuperAwesome_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::performance_tests::SuperAwesome_<ContainerAllocator>& v)
  {
    ...
    s << indent << "awesome: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.awesome);
  }
};
